...
This schema is automatically generated by `apps/strapi/src/populateDynamicZone` files and `documentMiddleware` mapping function which adds required populate schema to each component from dynamic zone.
