...
export function FeaturedBlogPost({
  ...
  return (
    <Link
      href={`/blog/${slug}`}
      className="border-strapi-gray-700/50 group/featured-blog-post-row before:gradient-border-purple relative flex items-center gap-4 rounded-2xl border transition-[border-color] duration-300 before:pointer-events-none before:absolute before:inset-0 before:z-10 before:rounded-2xl before:opacity-0 before:transition-opacity before:duration-300 hover:border-transparent hover:before:opacity-100"
    >
