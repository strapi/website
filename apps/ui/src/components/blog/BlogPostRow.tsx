...
export function BlogPostRow({
  ...
  return (
    <div
      className={cn(
        "border-strapi-gray-700/50 group/blog-post-row relative grid items-center gap-x-4 gap-y-2 rounded-2xl border px-5 py-4 transition-[border-color] duration-300 sm:px-8",
