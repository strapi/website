...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-background pl-2.5 pr-2 py-1 text-sm font-medium hover:bg-strapi-blue-200/65 hover:text-strapi-blue-600 focus:bg-strapi-blue-200/65 focus:text-strapi-blue-600 disabled:pointer-events-none disabled:opacity-65 data-[state=open]:hover:bg-strapi-blue-200/65 data-[state=open]:text-strapi-blue-600 data-[state=open]:focus:bg-strapi-blue-200/65 data-[state=open]:bg-strapi-blue-200/65 focus-visible:ring-ring/65 outline-none transition-[background,color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1"
)
  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          "bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=open]:slide-in-from-top-20 data-[state=closed]:slide-out-to-top-20 rounded-strapi-lg border-strapi-neutral-200 relative mt-4 h-[var(--radix-navigation-menu-viewport-height)] w-[var(--radix-navigation-menu-viewport-width)] max-w-[calc(100vw-2rem)] origin-top overflow-hidden border shadow-[0px_10px_35px_0px_rgba(0,0,0,0.06)] transition-[width,height] duration-200 data-[state=closed]:duration-200 data-[state=open]:duration-300",
          className
        )}
        {...props}
      />
